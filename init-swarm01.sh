...
docker run -d -h swarm01 -v /var/consul:/data \
    ...
    192.168.7.100:5000/progrium-consul -server -advertise 192.168.7.101 -join 192.168.7.100

docker run -d 192.168.7.100:5000/swarm join --addr=192.168.7.101:2375 consul://192.168.7.101:8500
